...
def insertimage():
    ...
    filename = filedialog.askopenfilename(initialdir=os.getcwd(),title="Select image file",filetype=(("PNG file","*.png"),("All file","text.txt")))
...
#icon
image_icon = PhotoImage(file="ddrawingbboard/imagess/logo.png")
root.iconphoto(False,image_icon)

##sidebar
color_box =PhotoImage(file="ddrawingbboard/imagess/color section.png")
Label(root,image=color_box,bg="#f2f3f5").place(x=10,y=20)

eraser = PhotoImage(file="ddrawingbboard/imagess/eraser.png")
Button(root,image=eraser,background="#f2f3f5",command=new_canvas).place(x=30,y=400)

importimage = PhotoImage(file="ddrawingbboard/imagess/addimage.png")
Button(root,image=importimage,background="white",command=insertimage).place(x=30,y=450)
